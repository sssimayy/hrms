...
public class MHTKPSPublicSoap
{
    ...
    public MHTKPSPublicSoap(){}

    public MHTKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public MHTKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        MHTExtendedSoapSerializationEnvelope envelope= new MHTExtendedSoapSerializationEnvelope(MHTExtendedSoapSerializationEnvelope.VER11);
