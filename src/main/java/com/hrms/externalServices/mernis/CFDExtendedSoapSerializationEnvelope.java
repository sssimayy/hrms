...
public class CFDExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CFDDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new CFDStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CFDDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CFDDateTimeConverter dateTimeConverter = new CFDStandardDateTimeConverter();

    public CFDExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CFDExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CFDMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CFDHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CFDExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CFDHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
