...
public class CFDKPSPublicSoap
{
    ...
    public CFDKPSPublicSoap(){}

    public CFDKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CFDKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CFDExtendedSoapSerializationEnvelope envelope= new CFDExtendedSoapSerializationEnvelope(CFDExtendedSoapSerializationEnvelope.VER11);
